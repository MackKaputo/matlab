 ...
 */
FARPROC WINAPI graphDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = graphDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = graphDelayLoadWin32FailureHook;
#endif
